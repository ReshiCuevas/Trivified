...
final List<Category> categories = [
  ...
  Category(20, "Mythology", icon: FontAwesomeIcons.landmark),
  ...
  Category(24, "Politics", icon: FontAwesomeIcons.personBooth),
  Category(25, "Art", icon: FontAwesomeIcons.paintbrush),
  Category(26, "Celebrities", icon: FontAwesomeIcons.faceLaughWink),
  Category(27, "Animals", icon: FontAwesomeIcons.dog),
  Category(28, "Vehicles", icon: FontAwesomeIcons.carRear),
  Category(29, "Comics", icon: FontAwesomeIcons.mask),
  ...
  Category(32, "Cartoon & Animation", icon: FontAwesomeIcons.robot),
];
